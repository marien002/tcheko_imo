...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        @if(auth()->check() && auth()->user()->role == 'admin')
        <a class="nav-link collapsed" href="{{ route('admin.operation.index') }}" >
          <i class="bi bi-tools"></i>
 
          <button type="button" refresh-btn class="btn btn-outline-primary">
            Opérations <span class="badge " id="notification-icon"></span>
          </button>
        </a>

        @else
        <a class="nav-link collapsed" href="{{ route('operation.create') }}" >
          <i class="bi bi-tools"></i>
          <button type="button" refresh-btn class="btn btn-outline-primary">
            Opérations <span class="badge " id="notification-icon"></span>
          </button>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">Marien , Chekina et Joseph</a>
    </div>
  </footer><!-- End Footer -->
